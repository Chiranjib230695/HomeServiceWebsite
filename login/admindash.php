     ...
     <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a hef="home.html"><img src="img/logg.png" alt="logo" class="hidden-xs hidden-sm">
                        <img src="img/logg.png" alt="logo" class="visible-xs visible-sm circle-logo">
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li class="active"><a href="#"><i class="	fa fa-dashboard" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Dashboard</span></a></li>
                        <li><a href="viewjoining.php"><i class="fa fa-group" aria-hidden="true"></i><span class="hidden-xs hidden-sm">New Apply</span></a></li>
                        <li><a href="viewaccept.php"><i class="fa fa-check-circle" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Approve Vandor</span></a></li>
                        <li><a href="viewreject.php"><i class="fa fa-trash" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Rejected</span></a></li>
                        <li><a href="#"><i class="fa fa-file-image-o" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Gallery</span></a></li>
                    ...
                    <header>
                      ...
                      <div class="row">
                       <div class="col-l-3 col-md-6">
                        <span class=" d-inline-block " data-toggle="popover" data-content="Disabled popover"></span>
                          <a href="viewjoining.php"> <button class="btn btn-primary "  type="button" disabled><i class="fa fa-group" style="font-size:24px"></i> <br> New Apply</button> </a>
                        </span>
                        <span class="d-inline-block" data-toggle="popover" >
                          <a href="viewaccept.php"><button class="btn btn-success bg-success " type="button" ><i class="fa fa-check-circle" style="font-size:24px"></i><br> Approve</button> </a>
                        </span>
                        <span class="d-inline-block m-5" data-toggle="popover" data-content="Disabled popover">
                          <a href="viewreject.php"><button class="btn btn-danger" style="pointer-events: none;" type="button" ><i class="fa fa-trash" style="font-size:24px"></i><br> Rejected</button> </a>
                        </span>
                        <span class="d-inline-block" data-toggle="popover" data-content="Disabled popover">
                          <a href="#"><button class="btn btn-warning" style="pointer-events: none;" type="button" ><i class="	fa fa-file-image-o" style="font-size:24px"></i><br> Gallery </button> </a>
                        </span>
