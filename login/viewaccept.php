...
<div class="container">
    ...
    <tbody>
			...
			if(isset($_POST["submit"]))
			{
				...
				$sql="SELECT * from accept where name like '$key_word%'";	

			}
				else
				{
					$sql="SELECT * from accept order by regdate asc";
				}
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					echo '<td align="center">
							<a href="undoaccept.php?id='.$row["id"].'">
							<input class="btn btn-primary" type="submit" id="undoaccept" name="undoaccept" value="Undo Accept">
							&emsp;
							
							</td>';

					echo '<td align="center">
							<a href="rejectjoinaccept.php?id='.$row["id"].'">
